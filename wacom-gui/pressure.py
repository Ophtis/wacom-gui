...
#from PySide6.QtGui import QWidget, QPolygonF, QPainter, QPen, QBrush, QColor, \
...
#from PySide6.QtCore import QObject, SIGNAL, SLOT, QPointF, Qt, QRectF, QPointF, QString, QRect
...
class pressure(QtGui.QWidget):
    def __init__(self, name, sensor, parent=None):
        ...
        self.sensor = sensor
        if self.sensor in ['stylus', 'eraser']:
            self.settings = pressureSettings(self.tabletName)
            self.settings.setSensor(self.sensor)
